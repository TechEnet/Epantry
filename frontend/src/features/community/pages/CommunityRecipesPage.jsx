              ...
              <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
                  <div>
                      ...
                      <p className="mt-4 max-w-3xl text-sm leading-7 text-stone-600">
                          Create, adapt and review recipes without weakening EPANTRY Recipe Engine truth. Creator statements stay visibly separate from platform-calculated Food Intelligence.
                      </p>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2">
                      {canContribute ? (
                          <Link
                              to="/creator-studio"
                              className="focus-ring inline-flex items-center gap-2 rounded-full border border-stone-200 bg-white px-4 py-2.5 text-xs font-black text-stone-600 hover:border-emerald-300 hover:text-emerald-800"
                          >
                              <ChefHat
                                  size={15}
                              />
